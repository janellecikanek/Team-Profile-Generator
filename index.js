...
const generateHTML = ({ TeamMgrName, TeamMgrID, TeamMgrEmail, TeamMgrOfficeNumber, officeNumber, EngName, EngID, EngEmail, EngGithub, InternName, internID, InternEmail, internSchool }) =>
    `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
